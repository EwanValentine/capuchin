...
impl ::grpc::ClientStub for LeaderAPIClient {
...
pub struct LeaderAPIServer;


impl LeaderAPIServer {
    pub fn new_service_def<H : LeaderAPI + 'static + Sync + Send + 'static>(handler: H) -> ::grpc::rt::ServerServiceDefinition {
        let handler_arc = ::std::sync::Arc::new(handler);
        ::grpc::rt::ServerServiceDefinition::new("/leader.LeaderAPI",
            vec![
